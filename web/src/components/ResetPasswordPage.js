...
export default function ResetPasswordScreen({ email, onNavigate }) {
        ...
        <form style={styles.form} onSubmit={handleSubmit}>
          ...
          <div style={styles.infoCard}>
            ...
            <div style={styles.infoTextContainer}>
              <h4 style={styles.infoTitle}>Syarat Password:</h4>
              <p style={styles.infoText}>• Minimal 8 karakter</p>
          ...
          >
            {loading || success ? (
              ...
              <>
                <span style={styles.submitButtonText}>Reset Password</span>
